...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $ret="select UserName from tblstudent3 where UserName=:uname || StuID=:stuid";
...
$sql="insert into tblstudent3(StudentName,StudentEmail,StudentClass,Gender,DOB,StuID,FatherName,MotherName,ContactNumber,AltenateNumber,Address,UserName,Password,Image)values(:stuname,:stuemail,:stuclass,:gender,:dob,:stuid,:fname,:mname,:connum,:altconnum,:address,:uname,:password,:image)";
